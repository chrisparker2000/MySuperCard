...
#define DEFAULT_FACE_CARD_SCALE_FACTOR 1.051
...
-(void)setFaceCardScaleFactor:(CGFloat)faceCardScaleFactor
{
    ...
    NSLog(@"scale factor = %f",faceCardScaleFactor);
...
-(void)pinch: (UIPinchGestureRecognizer *)gesture
{
 ...
 - (void)drawRect:(CGRect)rect
 {
     ...
     if (self.faceUp) {
         UIImage *faceImage = [UIImage imageNamed:[NSString stringWithFormat:@"%@%@.png", self.suit,[self rankAsString]]];
         if (faceImage) {
